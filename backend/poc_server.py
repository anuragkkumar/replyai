"""
ReplyAI POC - Core functionality test
Tests: Groq API, rate limiting, validation, sanitization, security
"""
...
async def generate_reply(request: Request, data: GenerateRequest) -> GenerateResponse:
    ...
    try:
        ...
        # Return response (no logging of user messages)
        ...
        # This should be caught by slowapi handler, but just in case
        raise HTTPException(
            status_code=429, 
